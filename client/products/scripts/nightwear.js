...
window.addEventListener('load',async function (){
    const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/nightwear/retrieve.php?');
    ...
    for (const wishButton of wishButtons) {
       wishButton.addEventListener('click', async function (event) {
            ...
            const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/nightwear/retrieve.php?productid=' + product_id);
            const json = await response.json();
