...
async function renderDressMaterial() {
    ...
    const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/dressMaterials/retrieve.php?');
...
async function renderKurti() {
    ...
    const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/kurtis/retrieve.php?');
    const json = await response.json();
    const array = json.data;
    array.map((x) => {
        appendData(x);
    ...
    for (const wishButton of wishButtons) {
       wishButton.addEventListener('click', async function (event) {
            ...
            const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/kurtis/retrieve.php?productid=' + product_id);
            const json = await response.json();
            ...
            fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/user/wishlist/add.php', {
                method: 'POST',
                headers: {
    ...
    for (const cartButton of cartButtons) {
        cartButton.addEventListener('click', async function (event) {
            ...
            fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/user/cart/add.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
...
async function renderLeggings() {
    ...
    const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/leggings/retrieve.php?');
    const json = await response.json();
    const array = json.data;
    array.map((x) => {
        appendData(x);
    ...
    for (const wishButton of wishButtons) {
       wishButton.addEventListener('click', async function (event) {
            ...
            const product_id =wishButton.id;
            console.log(product_id);
            const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/leggings/retrieve.php?productid=' + product_id);
            const json = await response.json();
            const object = json.data;
            console.log(object);
            const data = {
...
async function renderGhagra() {
    ...
    for (const wishButton of wishButtons) {
       wishButton.addEventListener('click', async function (event) {
            ...
            const product_id =wishButton.id;
            console.log(product_id);
            const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/ghagra/retrieve.php?productid=' + product_id);
            const json = await response.json();
            const object = json.data;
            console.log(object);
            const data = {
...
async function renderPalazzos() {
    ...
    const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/plazzos/retrieve.php?');
    const json = await response.json();
    const array = json.data;
    array.map((x) => {
        appendData(x);
    ...
    for (const wishButton of wishButtons) {
       wishButton.addEventListener('click', async function (event) {
            ...
            const product_id =wishButton.id;
            console.log(product_id);
            const response = await fetch('https://testing1.thestrategybook.com/deepak-ecommerce/server/api/products/plazzos/retrieve.php?productid=' + product_id);
            const json = await response.json();
            const object = json.data;
            console.log(object);
            const data = {
