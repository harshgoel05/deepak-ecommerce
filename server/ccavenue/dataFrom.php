...
<body>
	...
	<form method="post" name="customerData" action="ccavRequestHandler.php">
		...
		<table width="40%" height="100" border='1' align="center">
			...
			<tr>
				<td>Merchant Id :</td>
				<td><input type="text" name="merchant_id" value=<?php echo  "'" . MERCHANT_ID . "'" ?> /></td>
			</tr>
			<tr>
				<td>Order Id :</td>
			...
			<tr>
				<td>Redirect URL :</td>
				<td><input type="text" name="redirect_url" value=<?php echo "https://shreedeepaksarees.com/server/ccavenue" . "/ccavResponseHandler.php" ?> /></td>
			</tr>
			<tr>
				<td>Cancel URL :</td>
				<td><input type="text" name="cancel_url" value=<?php echo "https://shreedeepaksarees.com/server/ccavenue" . "/ccavResponseHandler.php" ?> /></td>
			</tr>
			<tr>
				<td>Language :</td>
